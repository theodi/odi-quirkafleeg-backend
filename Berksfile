...
cookbook 'odi-statsd', github: 'theodi/odi-chef', rel: "site-cookbooks/odi-statsd"
cookbook 'odi-rvm', github: 'theodi/odi-chef', rel: "site-cookbooks/odi-rvm"

cookbook 'dictionary', github: 'theodi/chef-dictionary'
cookbook 'rvm', github: 'theodi/chef-rvm'
cookbook 'envbuilder', github: 'theodi/chef-envbuilder'
cookbook 'odi-nginx', github: 'theodi/chef-odi-nginx'
